...
| File | Role |
|---|---|
| `app.py` | Main Streamlit app, assembles all tabs. Current tabs: **Lesen, Hören, Vokabeln, Grammatik** (4 tabs — `Aufgaben erstellen` and the old separate `Theorie`/`Grundlagen` split are both gone, see below). |
...
Full target tab structure, agreed 16.09.2026: **Grammatik | Lesen | Hören | Schreiben | Sprechen | Vokabeln**. Status:
