...
Antworte NUR mit JSON:
[{{"frage": "Fragetext oder Lückensatz", "optionen": ["Option A", "Option B", "Option C", "Option D"], "richtig_index": 0, "erklaerung": "Kurze Begründung, warum diese Antwort richtig ist"}}]"""
